<?php
// session_start ensures the session is started for the current page
session_start();
...
<body>
    <div class="sidebar">
        <div class="item1">Student</div>
        <img src="images/user-profile-front-side.jpg" class="profile_pic">
        <div class="item2">
