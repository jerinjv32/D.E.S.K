...
<head>
    ...
    <link rel="stylesheet" href="/staff_panel_style.css">
    ...
    <main>
        <div class="panels">
            <div class="panel_col1" onclick="redirect('profile.php')">
                <img src="/icons/coure_management.png" class="icons" alt="my_profile">
            ...
            <div class="panel_col3" onclick="redirect('result.php')">
                <img src="/icons/results.png" class="icons" alt="results">
            ...
            <div class="panel_col5" onclick="redirect('remedial.php')">
                <img src="/icons/remedial_class.png" class="icons" alt="remedial class">
